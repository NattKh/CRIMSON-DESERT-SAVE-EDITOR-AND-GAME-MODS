...
def _splice_socket_elements(
    ...
    sock_abs = item.field_offsets.get('_socketSaveDataList')
    ...
    valid_updated = False
    valid_sock_abs = item.field_offsets.get('_validSocketCount')
    if not isinstance(valid_sock_abs, int) and fp(bitmask, 12):
