...
class ItemBuffsTab(QWidget):
    ...
    def _buff_sync_community_names(self) -> None:
        # OFFLINE BUILD: community buff-name download removed — local data only.
        self._buff_status_label.setText("Online sync removed (offline build) — using local buff names.")
